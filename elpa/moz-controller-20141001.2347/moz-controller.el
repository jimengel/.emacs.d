...
(defvar firefox-bin "/Applications/Firefox43.app/Contents/MacOS/firefox"
...
(defun moz-controller-open-url ( url )
  "Macro for defininga moz commands."
  (interactive "sEnter URL ")
  (setq jsString (concat "content.location.href='" url "';"))
  (comint-send-string
   (inferior-moz-process)
   jsString
   )
...
(defun moz-controller-start-firefox ()
  "Starts up firefox"
  (interactive)
  ;;(call-process Firefox.app )
  (call-process firefox-bin nil "firefox-buf" nil "-P emacs" "" "")
  ;;(call-process (concat alac-bin-dir "alacBuild") nil "alac-build-buf" nil "u" "-f" list-buffers-directory
...
(defun-moz-controller-command moz-controller-tab-open ()
  "Open new tab"
  "content.window.open();"
  )

(defun-moz-controller-command moz-controller-window-back ()
  "Go back"
  "content.window.back();"
  )

(defun-moz-controller-command moz-controller-window-forward ()
  "Go back"
...
(unless moz-controller-mode-map
  (setq moz-controller-mode-map
	  ...
	  (define-key moz-controller-map (kbd "C-c m o") 'moz-controller-tab-open)
